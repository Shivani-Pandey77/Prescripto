...
<Link onClick={()=>scrollTo({top: 0, behavior: 'smooth'})} key={index} to={`/Prescripto/doctors/${item.speciality}`} className="m-2 flex flex-col item-center text-sm  cursor-pointer flex shrink-0 hover:translate-y-[-10px] transition-all duration 500">
